    ...
    return (
        <div className="max-w-7xl mx-auto px-6 py-12 space-y-12 animate-fade-in">
            <div className="relative overflow-hidden bg-slate-900 premium-card p-10 flex flex-col md:flex-row items-center justify-between gap-8 border-none ring-1 ring-white/10">
                ...
                <div className="relative z-10 flex bg-white/5 p-1.5 rounded-2xl w-full md:w-auto border border-white/10 backdrop-blur-md">
                    <button
                        onClick={() => setViewMode("manage")}
                        className={`flex-1 md:flex-none px-8 py-3 rounded-xl text-sm font-bold transition-all duration-300 flex items-center justify-center gap-2 ${viewMode === "manage" ? "bg-blue-600 text-white shadow-lg shadow-blue-500/30" : "text-slate-400 hover:text-white"}`}
                    >
                        <Zap size={18} />
                        Live Queue
                    </button>
                    <button
                        ...
                        className={`flex-1 md:flex-none px-8 py-3 rounded-xl text-sm font-bold transition-all duration-300 flex items-center justify-center gap-2 ${viewMode === "directory" ? "bg-blue-600 text-white shadow-lg shadow-blue-500/30" : "text-slate-400 hover:text-white"}`}
                    >
                        <Building2 size={18} />
                        Directory
                    </button>
