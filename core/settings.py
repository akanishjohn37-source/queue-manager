...
SECRET_KEY = 'django-insecure-replace-this-with-your-own-key-for-prod'
DEBUG = True
ALLOWED_HOSTS = []
...
MIDDLEWARE = [
    "corsheaders.middleware.CorsMiddleware",  # <-- MUST be near top, before CommonMiddleware
...
# CORS (development only) — adjust origins for your frontend/dev server
CORS_ALLOWED_ORIGINS = [
    "http://127.0.0.1:5173",
    "http://localhost:5173",
    "http://localhost:3000",
